...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Muse",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC4Muse25iPhoneWatchSessionManager")
@interface iPhoneWatchSessionManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@interface iPhoneWatchSessionManager (SWIFT_EXTENSION(Muse)) <WCSessionDelegate>
